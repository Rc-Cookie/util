package de.rccookie.util.redirect;
...
public class RedirectReceiver {
    ...
    public static void main(String[] rawArgs) throws Exception {
        ...
        Options options = parser.parse(rawArgs);

        int port = options.getIntOr("port", Redirector.DEFAULT_PORT);
        boolean loop = options.is("loop");
